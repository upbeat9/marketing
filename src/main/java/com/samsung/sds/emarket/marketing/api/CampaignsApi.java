...
public interface CampaignsApi {
     ...
     * @return Approved (status code 200)
     */
    @ApiOperation(value = "", nickname = "deleteCampaign", notes = "Delete a campaign with the specified id", response = Boolean.class, tags={ "Campaigns", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Approved", response = Boolean.class) })
    @RequestMapping(
